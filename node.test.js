...
(function ($_1) {
    ...
    (function ($$) {
        $mol_test({
            "Composed keys"($) {
                $mol_assert_equal('$mol_schema_boolean', $mol_schema_boolean + '');
                $mol_assert_equal('$mol_schema_enum<[false,123,"foo"]>', $mol_schema_enum([false, 123, 'foo']) + '', $mol_key($mol_schema_enum([false, 123, 'foo'])));
                $mol_assert_equal('$mol_schema_some<[$mol_schema_float,$mol_schema_string]>', $mol_schema_some([$mol_schema_float, $mol_schema_string]) + '');
                $mol_assert_equal('$mol_schema_every<[$mol_schema_integer,$mol_schema_range<5,9>]>', $mol_schema_every([$mol_schema_integer, $mol_schema_range(5, 9)]) + '');
                $mol_assert_equal('$mol_schema_array<$mol_schema_float>', $mol_schema_array($mol_schema_float) + '');
                $mol_assert_equal('$mol_schema_record<{"name":$mol_schema_string}>', $mol_schema_record({ name: $mol_schema_string }) + '');
                $mol_assert_equal('Some', class Some extends $mol_schema_enum([123]) {
