...
declare namespace $ {
    export abstract class $mol_schema extends Object {
        ...
        static toString(): string;
        static check(val: unknown): boolean;
    ...
    export function $mol_schema_enum<Options extends readonly unknown[]>(Options: Options): {
        ...
        Options: Options;
        toString(): string;
        check(val: unknown): val is Options[number];
        cast(val: unknown): Options[number];
        default: Options[number];
        guard<Val>(val: Val): Val;
        [Symbol.toStringTag]: string;
    ...
    export function $mol_schema_some<Variants extends readonly (typeof $mol_schema)[]>(Variants: Variants): {
        ...
        Variants: Variants;
        toString(): string;
        check(val: unknown): val is Variants[number]["default"];
        cast(val: unknown): Variants[number]["default"];
    ...
    export function $mol_schema_every<Schemes extends readonly (typeof $mol_schema)[]>(Schemes: Schemes): {
        ...
        Schemes: Schemes;
        toString(): string;
        check(val: unknown): val is $mol_type_intersect<Schemes[number]["default"]>;
        cast(val: unknown): $mol_type_intersect<Schemes[number]["default"]>;
        default: $mol_type_intersect<Schemes[number]["default"]>;
        guard<Val>(val: Val): Val;
        [Symbol.toStringTag]: string;
        [$mol_key_handle](): string;
        getPrototypeOf(o: any): any;
    ...
    export function $mol_schema_range<Value extends number, Min extends Value, Max extends Value>(Min: Min, Max: Max): {
        ...
        Max: Max;
        toString(): string;
        check(val: Value): val is Value & { [key in `$mol_schema_range_min=${Min}`]: true; } & { [key_1 in `$mol_schema_range_max=${Max}`]: true; };
    ...
    const $mol_schema_natural_base: {
        ...
        Schemes: (typeof $mol_schema_integer | typeof $mol_schema_positive)[];
        toString(): string;
        check(val: unknown): val is number & $mol_schema_integer & {
            "$mol_schema_range_min=0": true;
        } & {
            [x: `$mol_schema_range_max=${number}`]: true;
        };
        cast(val: unknown): number & $mol_schema_integer & {
            "$mol_schema_range_min=0": true;
        } & {
            [x: `$mol_schema_range_max=${number}`]: true;
        };
    ...
    export abstract class $mol_schema_list extends $mol_schema {
        ...
        static default: readonly unknown[];
    }
    export function $mol_schema_array<Item extends typeof $mol_schema>(Item: Item): {
        ...
        Item: Item;
        toString(): string;
        check(val: unknown): val is readonly unknown[];
        cast(val: unknown): readonly unknown[];
    ...
    export abstract class $mol_schema_object extends $mol_schema {
        ...
        static default: Readonly<Record<string, unknown>>;
    }
    export function $mol_schema_record<Fields extends Record<string, typeof $mol_schema>>(Fields: Fields): {
        ...
        Fields: Fields;
        toString(): string;
        check(val: unknown): val is { readonly [key in keyof Fields]: Fields[key]["default"]; };
        cast(val: unknown): { readonly [key in keyof Fields]: Fields[key]["default"]; };
...
declare namespace $ {
    type $bog_weather_app_code_scene = 'sunny' | 'cloudy' | 'foggy' | 'drizzle' | 'rain' | 'snow' | 'thunder' | 'night_clear' | 'night_cloudy';
    interface $bog_weather_app_code_info {
        description: string;
        icon: string;
        scene: $bog_weather_app_code_scene;
    }
    function $bog_weather_app_code_info(wmo_code: number, is_night?: boolean): $bog_weather_app_code_info;
}

declare namespace $ {

	type $mol_switch__value_bog_weather_app_hourly_view_1 = $mol_type_enforce<
		ReturnType< $bog_weather_app_hourly_view['tab'] >
		,
		ReturnType< $mol_switch['value'] >
	>
	type $mol_switch__options_bog_weather_app_hourly_view_2 = $mol_type_enforce<
		({ 
			'precip': string,
			'wind': string,
			'humidity': string,
	...
	>
	type $mol_view__sub_bog_weather_app_hourly_view_3 = $mol_type_enforce<
		ReturnType< $bog_weather_app_hourly_view['hour_items'] >
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_scroll__scroll_top_bog_weather_app_hourly_view_4 = $mol_type_enforce<
		number
		,
		ReturnType< $mol_scroll['scroll_top'] >
	>
	type $mol_scroll__sub_bog_weather_app_hourly_view_5 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_scroll['sub'] >
	>
	type $bog_weather_app_hourly_item__index_bog_weather_app_hourly_view_6 = $mol_type_enforce<
		ReturnType< $bog_weather_app_hourly_view['hour_index'] >
		,
		ReturnType< $bog_weather_app_hourly_item['index'] >
	>
	type $bog_weather_app_hourly_item__hourly_data_bog_weather_app_hourly_view_7 = $mol_type_enforce<
		ReturnType< $bog_weather_app_hourly_view['hourly_data'] >
		,
		ReturnType< $bog_weather_app_hourly_item['hourly_data'] >
	>
	type $bog_weather_app_hourly_item__tab_bog_weather_app_hourly_view_8 = $mol_type_enforce<
		ReturnType< $bog_weather_app_hourly_view['tab'] >
		,
		ReturnType< $bog_weather_app_hourly_item['tab'] >
	>
	export class $bog_weather_app_hourly_view extends $mol_view {
		tab( next?: string ): string
		Tabs( ): $mol_switch
		hour_items( ): readonly(any)[]
		Row( ): $mol_view
		Scroll( ): $mol_scroll
		hour_index( id: any): number
		hourly_data( ): any
		sub( ): readonly(any)[]
		Hour( id: any): $bog_weather_app_hourly_item
	}
	
	type $mol_view__sub_bog_weather_app_hourly_item_1 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_image__uri_bog_weather_app_hourly_item_2 = $mol_type_enforce<
		ReturnType< $bog_weather_app_hourly_item['icon_uri'] >
		,
		ReturnType< $mol_image['uri'] >
	>
	type $mol_view__sub_bog_weather_app_hourly_item_3 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_weather_app_hourly_item_4 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	export class $bog_weather_app_hourly_item extends $mol_view {
		time_text( ): string
		Time( ): $mol_view
		icon_uri( ): string
		Icon( ): $mol_image
...
//# sourceMappingURL=hourly.view.tree.d.ts.map
declare namespace $.$$ {
    class $bog_weather_app_hourly_view extends $.$bog_weather_app_hourly_view {
        hour_indices(): number[];
        hour_index(id: number): number;
        hour_items(): $.$bog_weather_app_hourly_item[];
    }
...
declare namespace $ {
	...
	type $bog_weather_app_daily_row__index_bog_weather_app_daily_1 = $mol_type_enforce<
		ReturnType< $bog_weather_app_daily['day_index'] >
		,
		ReturnType< $bog_weather_app_daily_row['index'] >
	>
	type $bog_weather_app_daily_row__daily_data_bog_weather_app_daily_2 = $mol_type_enforce<
		ReturnType< $bog_weather_app_daily['daily_data'] >
		,
		ReturnType< $bog_weather_app_daily_row['daily_data'] >
	>
	export class $bog_weather_app_daily extends $mol_list {
		day_rows( ): readonly(any)[]
		day_index( id: any): number
		daily_data( ): any
		rows( ): ReturnType< $bog_weather_app_daily['day_rows'] >
		Day( id: any): $bog_weather_app_daily_row
	}
	
	type $mol_view__sub_bog_weather_app_daily_row_1 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_image__uri_bog_weather_app_daily_row_2 = $mol_type_enforce<
		ReturnType< $bog_weather_app_daily_row['icon_uri'] >
		,
		ReturnType< $mol_image['uri'] >
	>
	type $mol_view__sub_bog_weather_app_daily_row_3 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_weather_app_daily_row_4 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_weather_app_daily_row_5 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_weather_app_daily_row_6 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_weather_app_daily_row_7 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_weather_app_daily_row_8 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_weather_app_daily_row_9 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_weather_app_daily_row_10 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_weather_app_daily_row_11 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	export class $bog_weather_app_daily_row extends $mol_expander {
		date_text( ): string
		Day_name( ): $mol_view
		icon_uri( ): string
		Icon( ): $mol_image
		temp_min_text( ): string
		Temp_min( ): $mol_view
		Bar( ): $mol_view
		temp_max_text( ): string
		Temp_max( ): $mol_view
		Summary( ): $mol_view
		sunrise_text( ): string
		Detail_sunrise( ): $mol_view
		sunset_text( ): string
		Detail_sunset( ): $mol_view
		uv_text( ): string
		Detail_uv( ): $mol_view
		wind_text( ): string
		Detail_wind( ): $mol_view
		precip_text( ): string
		Detail_precip( ): $mol_view
		Details( ): $mol_view
		index( ): number
		daily_data( ): any
		label( ): readonly(any)[]
...
//# sourceMappingURL=daily.view.tree.d.ts.map
declare namespace $.$$ {
    class $bog_weather_app_daily extends $.$bog_weather_app_daily {
        day_rows(): any;
        day_index(id: number): number;
    }
...
declare namespace $ {
	...
	type $mol_button_minor__click_bog_weather_app_search_1 = $mol_type_enforce<
		ReturnType< $bog_weather_app_search['trigger_click'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_button_minor__sub_bog_weather_app_search_2 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_minor['sub'] >
	>
	type $mol_search__query_bog_weather_app_search_3 = $mol_type_enforce<
		ReturnType< $bog_weather_app_search['query'] >
		,
		ReturnType< $mol_search['query'] >
	>
	type $mol_list__rows_bog_weather_app_search_4 = $mol_type_enforce<
		ReturnType< $bog_weather_app_search['result_rows'] >
		,
		ReturnType< $mol_list['rows'] >
	>
	type $mol_view__sub_bog_weather_app_search_5 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $bog_weather_app_search_row__location_bog_weather_app_search_6 = $mol_type_enforce<
		ReturnType< $bog_weather_app_search['result_location'] >
		,
		ReturnType< $bog_weather_app_search_row['location'] >
	>
	type $bog_weather_app_search_row__click_bog_weather_app_search_7 = $mol_type_enforce<
		ReturnType< $bog_weather_app_search['result_click'] >
		,
		ReturnType< $bog_weather_app_search_row['click'] >
	>
	export class $bog_weather_app_search extends $mol_pop {
		opened( next?: boolean ): boolean
		trigger_click( next?: any ): any
		Trigger_icon( ): $mol_icon_magnify
		...
		Results( ): $mol_list
		Panel( ): $mol_view
		result_location( id: any): any
		result_click( id: any, next?: any ): any
		showed( next?: ReturnType< $bog_weather_app_search['opened'] > ): ReturnType< $bog_weather_app_search['opened'] >
		align( ): string
		event_select( next?: any ): any
		anchor( ): readonly(any)[]
		bubble( ): readonly(any)[]
		Result( id: any): $bog_weather_app_search_row
	}
	
	type $mol_view__sub_bog_weather_app_search_row_1 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_weather_app_search_row_2 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	export class $bog_weather_app_search_row extends $mol_button_minor {
		name_text( ): string
		Name( ): $mol_view
		country_text( ): string
		Country( ): $mol_view
...
declare namespace $.$$ {
    class $bog_weather_app_search extends $.$bog_weather_app_search {
        ...
        result_rows(): $.$bog_weather_app_search_row[];
        ...
        result_click(index: number): void;
    }
...
//# sourceMappingURL=crosshairs.view.tree.d.ts.map
declare namespace $ {

	export class $mol_icon_crosshairs_gps extends $mol_icon {
		path( ): string
	}
...
declare namespace $ {
	...
	type $mol_image__uri_bog_weather_app_hero_1 = $mol_type_enforce<
		ReturnType< $bog_weather_app_hero['froggy_uri'] >
		,
		ReturnType< $mol_image['uri'] >
	>
	type $mol_view__sub_bog_weather_app_hero_2 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_weather_app_hero_3 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_weather_app_hero_4 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_weather_app_hero_5 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	export class $bog_weather_app_hero extends $mol_view {
		scene( ): string
		froggy_uri( ): string
		Froggy( ): $mol_image
		temp_text( ): string
		...
		is_night( ): boolean
		attr( ): ({ 
			'bog_weather_app_hero_scene': ReturnType< $bog_weather_app_hero['scene'] >,
		})  & ReturnType< $mol_view['attr'] >
		sub( ): readonly(any)[]
	}
...
declare namespace $ {
	...
	type $bog_weather_app_details_card__title_bog_weather_app_details_1 = $mol_type_enforce<
		string
		,
		ReturnType< $bog_weather_app_details_card['title'] >
	>
	type $bog_weather_app_details_card__value_bog_weather_app_details_2 = $mol_type_enforce<
		ReturnType< $bog_weather_app_details['wind_text'] >
		,
		ReturnType< $bog_weather_app_details_card['value'] >
	>
	type $bog_weather_app_details_card__title_bog_weather_app_details_3 = $mol_type_enforce<
		string
		,
		ReturnType< $bog_weather_app_details_card['title'] >
	>
	type $bog_weather_app_details_card__value_bog_weather_app_details_4 = $mol_type_enforce<
		ReturnType< $bog_weather_app_details['humidity_text'] >
		,
		ReturnType< $bog_weather_app_details_card['value'] >
	>
	type $bog_weather_app_details_card__title_bog_weather_app_details_5 = $mol_type_enforce<
		string
		,
		ReturnType< $bog_weather_app_details_card['title'] >
	>
	type $bog_weather_app_details_card__value_bog_weather_app_details_6 = $mol_type_enforce<
		ReturnType< $bog_weather_app_details['uv_text'] >
		,
		ReturnType< $bog_weather_app_details_card['value'] >
	>
	type $bog_weather_app_details_card__title_bog_weather_app_details_7 = $mol_type_enforce<
		string
		,
		ReturnType< $bog_weather_app_details_card['title'] >
	>
	type $bog_weather_app_details_card__value_bog_weather_app_details_8 = $mol_type_enforce<
		ReturnType< $bog_weather_app_details['pressure_text'] >
		,
		ReturnType< $bog_weather_app_details_card['value'] >
	>
	type $bog_weather_app_details_card__title_bog_weather_app_details_9 = $mol_type_enforce<
		string
		,
		ReturnType< $bog_weather_app_details_card['title'] >
	>
	type $bog_weather_app_details_card__value_bog_weather_app_details_10 = $mol_type_enforce<
		ReturnType< $bog_weather_app_details['sunrise_text'] >
		,
		ReturnType< $bog_weather_app_details_card['value'] >
	>
	type $bog_weather_app_details_card__title_bog_weather_app_details_11 = $mol_type_enforce<
		string
		,
		ReturnType< $bog_weather_app_details_card['title'] >
	>
	type $bog_weather_app_details_card__value_bog_weather_app_details_12 = $mol_type_enforce<
		ReturnType< $bog_weather_app_details['sunset_text'] >
		,
		ReturnType< $bog_weather_app_details_card['value'] >
	>
	export class $bog_weather_app_details extends $mol_view {
		wind_text( ): string
		Wind( ): $bog_weather_app_details_card
		humidity_text( ): string
		Humidity( ): $bog_weather_app_details_card
		uv_text( ): string
		UV( ): $bog_weather_app_details_card
		pressure_text( ): string
		Pressure( ): $bog_weather_app_details_card
		sunrise_text( ): string
		Sunrise( ): $bog_weather_app_details_card
		sunset_text( ): string
		Sunset( ): $bog_weather_app_details_card
		wind_speed( ): number
	...
	type $mol_view__sub_bog_weather_app_details_card_1 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_weather_app_details_card_2 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	export class $bog_weather_app_details_card extends $mol_view {
		Title( ): $mol_view
		Value( ): $mol_view
		title( ): string
		value( ): string
    ...
    class $bog_weather_app_api extends $mol_object {
        static forecast(coords: {
            ...
            readonly current: {
                ...
                readonly relative_humidity_2m: number & $mol_schema_integer;
                readonly weather_code: number & $mol_schema_integer;
                readonly wind_speed_10m: number;
                readonly wind_direction_10m: number & $mol_schema_integer;
                readonly pressure_msl: number;
                readonly uv_index: number;
            };
            readonly hourly: {
                readonly time: readonly unknown[];
                readonly temperature_2m: readonly unknown[];
                readonly precipitation_probability: readonly unknown[];
                readonly weather_code: readonly unknown[];
                readonly wind_speed_10m: readonly unknown[];
                readonly relative_humidity_2m: readonly unknown[];
            };
            readonly daily: {
                readonly time: readonly unknown[];
                readonly weather_code: readonly unknown[];
                readonly temperature_2m_max: readonly unknown[];
                readonly temperature_2m_min: readonly unknown[];
                readonly sunrise: readonly unknown[];
                readonly sunset: readonly unknown[];
                readonly uv_index_max: readonly unknown[];
                readonly wind_speed_10m_max: readonly unknown[];
                readonly precipitation_probability_max: readonly unknown[];
            };
        };
...
declare namespace $ {
    const $bog_weather_app_location_base: {
        new (value?: any): {
            constructor: Function;
            toString(): string;
            toLocaleString(): string;
        ...
        Fields: {
            ...
            latitude: typeof $mol_schema_float;
            longitude: typeof $mol_schema_float;
            country: typeof $mol_schema_string;
        };
        toString(): string;
        check(val: unknown): val is {
            readonly name: string;
            readonly latitude: number;
            readonly longitude: number;
            readonly country: string;
    ...
    export class $bog_weather_app_location extends $bog_weather_app_location_base {
    }
    const $bog_weather_app_geocode_response_base: {
        new (value?: any): {
            constructor: Function;
            toString(): string;
            toLocaleString(): string;
        ...
        Fields: {
            results: {
                ...
                Item: typeof $bog_weather_app_location;
                toString(): string;
                check(val: unknown): val is readonly unknown[];
                cast(val: unknown): readonly unknown[];
                default: readonly (typeof Item.default)[];
    ...
    export class $bog_weather_app_geocode_response extends $bog_weather_app_geocode_response_base {
    }
    const $bog_weather_app_current_base: {
        new (value?: any): {
            constructor: Function;
            toString(): string;
            toLocaleString(): string;
        ...
        Fields: {
            temperature_2m: typeof $mol_schema_float;
            apparent_temperature: typeof $mol_schema_float;
            relative_humidity_2m: typeof $mol_schema_integer;
            weather_code: typeof $mol_schema_integer;
            wind_speed_10m: typeof $mol_schema_float;
            wind_direction_10m: typeof $mol_schema_integer;
            pressure_msl: typeof $mol_schema_float;
            uv_index: typeof $mol_schema_float;
        };
        toString(): string;
        check(val: unknown): val is {
            readonly temperature_2m: number;
    ...
    export class $bog_weather_app_current extends $bog_weather_app_current_base {
    }
    const $bog_weather_app_hourly_schema_base: {
        new (value?: any): {
            constructor: Function;
            toString(): string;
            toLocaleString(): string;
        ...
        Fields: {
            ...
            precipitation_probability: {
                ...
                Item: typeof $mol_schema_integer;
                toString(): string;
                check(val: unknown): val is readonly unknown[];
                cast(val: unknown): readonly unknown[];
                default: readonly (typeof Item.default)[];
    ...
    export class $bog_weather_app_hourly_schema extends $bog_weather_app_hourly_schema_base {
    }
    const $bog_weather_app_daily_schema_base: {
        new (value?: any): {
            constructor: Function;
            toString(): string;
            toLocaleString(): string;
    ...
    export class $bog_weather_app_daily_schema extends $bog_weather_app_daily_schema_base {
    }
    const $bog_weather_app_forecast_base: {
        new (value?: any): {
            constructor: Function;
            toString(): string;
            toLocaleString(): string;
        ...
        Fields: {
            current: typeof $bog_weather_app_current;
            hourly: typeof $bog_weather_app_hourly_schema;
            daily: typeof $bog_weather_app_daily_schema;
        };
        toString(): string;
        check(val: unknown): val is {
            readonly current: {
    ...
    export class $bog_weather_app_forecast extends $bog_weather_app_forecast_base {
    }
    export {};
}
...
declare namespace $ {
	...
	type $mol_view__sub_bog_weather_app_1 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $bog_weather_app_search__event_select_bog_weather_app_2 = $mol_type_enforce<
		ReturnType< $bog_weather_app['on_city_select'] >
		,
		ReturnType< $bog_weather_app_search['event_select'] >
	>
	type $mol_button_minor__click_bog_weather_app_3 = $mol_type_enforce<
		ReturnType< $bog_weather_app['geolocate'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_button_minor__sub_bog_weather_app_4 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_minor['sub'] >
	>
	type $bog_theme_toggle__theme_auto_bog_weather_app_5 = $mol_type_enforce<
		ReturnType< $bog_weather_app['Theme'] >
		,
		ReturnType< $bog_theme_toggle['theme_auto'] >
	>
	type $mol_view__sub_bog_weather_app_6 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $bog_weather_app_hero__weather_code_bog_weather_app_7 = $mol_type_enforce<
		ReturnType< $bog_weather_app['current_weather_code'] >
		,
		ReturnType< $bog_weather_app_hero['weather_code'] >
	>
	type $bog_weather_app_hero__temperature_bog_weather_app_8 = $mol_type_enforce<
		ReturnType< $bog_weather_app['current_temperature'] >
		,
		ReturnType< $bog_weather_app_hero['temperature'] >
	>
	type $bog_weather_app_hero__apparent_temperature_bog_weather_app_9 = $mol_type_enforce<
		ReturnType< $bog_weather_app['current_apparent_temperature'] >
		,
		ReturnType< $bog_weather_app_hero['apparent_temperature'] >
	>
	type $bog_weather_app_hero__temp_max_bog_weather_app_10 = $mol_type_enforce<
		ReturnType< $bog_weather_app['today_temp_max'] >
		,
		ReturnType< $bog_weather_app_hero['temp_max'] >
	>
	type $bog_weather_app_hero__temp_min_bog_weather_app_11 = $mol_type_enforce<
		ReturnType< $bog_weather_app['today_temp_min'] >
		,
		ReturnType< $bog_weather_app_hero['temp_min'] >
	>
	type $bog_weather_app_hero__is_night_bog_weather_app_12 = $mol_type_enforce<
		ReturnType< $bog_weather_app['is_night'] >
		,
		ReturnType< $bog_weather_app_hero['is_night'] >
	>
	type $bog_weather_app_hourly_view__hourly_data_bog_weather_app_13 = $mol_type_enforce<
		ReturnType< $bog_weather_app['hourly_data'] >
		,
		ReturnType< $bog_weather_app_hourly_view['hourly_data'] >
	>
	type $bog_weather_app_daily__daily_data_bog_weather_app_14 = $mol_type_enforce<
		ReturnType< $bog_weather_app['daily_data'] >
		,
		ReturnType< $bog_weather_app_daily['daily_data'] >
	>
	type $bog_weather_app_details__wind_speed_bog_weather_app_15 = $mol_type_enforce<
		ReturnType< $bog_weather_app['current_wind_speed'] >
		,
		ReturnType< $bog_weather_app_details['wind_speed'] >
	>
	type $bog_weather_app_details__wind_direction_bog_weather_app_16 = $mol_type_enforce<
		ReturnType< $bog_weather_app['current_wind_direction'] >
		,
		ReturnType< $bog_weather_app_details['wind_direction'] >
	>
	type $bog_weather_app_details__humidity_bog_weather_app_17 = $mol_type_enforce<
		ReturnType< $bog_weather_app['current_humidity'] >
		,
		ReturnType< $bog_weather_app_details['humidity'] >
	>
	type $bog_weather_app_details__uv_index_bog_weather_app_18 = $mol_type_enforce<
		ReturnType< $bog_weather_app['current_uv_index'] >
		,
		ReturnType< $bog_weather_app_details['uv_index'] >
	>
	type $bog_weather_app_details__pressure_bog_weather_app_19 = $mol_type_enforce<
		ReturnType< $bog_weather_app['current_pressure'] >
		,
		ReturnType< $bog_weather_app_details['pressure'] >
	>
	type $bog_weather_app_details__sunrise_bog_weather_app_20 = $mol_type_enforce<
		ReturnType< $bog_weather_app['today_sunrise'] >
		,
		ReturnType< $bog_weather_app_details['sunrise'] >
	>
	type $bog_weather_app_details__sunset_bog_weather_app_21 = $mol_type_enforce<
		ReturnType< $bog_weather_app['today_sunset'] >
		,
		ReturnType< $bog_weather_app_details['sunset'] >
	>
	type $mol_list__rows_bog_weather_app_22 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_list['rows'] >
	>
	type $bog_theme_auto__theme_light_bog_weather_app_23 = $mol_type_enforce<
		string
		,
		ReturnType< $bog_theme_auto['theme_light'] >
	>
	type $bog_theme_auto__theme_dark_bog_weather_app_24 = $mol_type_enforce<
		string
		,
		ReturnType< $bog_theme_auto['theme_dark'] >
	>
	type $bog_theme_auto__themes_bog_weather_app_25 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $bog_theme_auto['themes'] >
	>
	export class $bog_weather_app extends $mol_scroll {
		city_name( ): string
		City_name( ): $mol_view
		on_city_select( next?: any ): any
		Search( ): $bog_weather_app_search
		geolocate( next?: any ): any
		Geolocate_icon( ): $mol_icon_crosshairs_gps
		Geolocate( ): $mol_button_minor
		Theme_toggle( ): $bog_theme_toggle
		Header( ): $mol_view
		current_weather_code( ): number
		current_temperature( ): number
		current_apparent_temperature( ): number
		today_temp_max( ): number
		today_temp_min( ): number
		is_night( ): boolean
		Hero( ): $bog_weather_app_hero
		hourly_data( ): any
		Hourly( ): $bog_weather_app_hourly_view
		daily_data( ): any
		Daily( ): $bog_weather_app_daily
		current_wind_speed( ): number
		current_wind_direction( ): number
		current_humidity( ): number
		current_uv_index( ): number
		current_pressure( ): number
		today_sunrise( ): string
		today_sunset( ): string
		Details( ): $bog_weather_app_details
		Body( ): $mol_list
...
declare namespace $.$$ {
    class $bog_weather_app extends $.$bog_weather_app {
        lat(next?: number): number;
        lon(next?: number): number;
        ...
        city_name(next?: string): string;
        on_city_select(location: any): void;
        geolocate(): void;
    }
}
